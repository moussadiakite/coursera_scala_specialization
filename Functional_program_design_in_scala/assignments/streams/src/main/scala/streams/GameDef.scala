...
trait GameDef {
  ...
  case class Pos(row: Int, col: Int) {
    ...
    /** True if the two positions are the same **/
    def ==(other: Pos) = row == other.row && col == other.col
  }
  ...
  case class Block(b1: Pos, b2: Pos) {
    ...
    /**
      * Returns `true` if the block is standing at pos
      */
    def isStandingAtPos(pos: Pos): Boolean = isStanding && b1 == pos
    ...
    def ==(other: Block): Boolean = b1 == other.b1 && b2 == other.b2
  }
}
