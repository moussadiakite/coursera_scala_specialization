  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var twoTimesA = (2 * $uD(a$2.apply__O()));
        var array$1 = [(((-$uD(b$2.apply__O())) - $uD(delta$1.apply__O())) / twoTimesA), (((-$uD(b$2.apply__O())) + $uD(delta$1.apply__O())) / twoTimesA)];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    var signal = $as_Lcalculator_Signal(x$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, name$1, signal$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(signal$1.apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(name$1)))
      })
    })(this, name, signal));
